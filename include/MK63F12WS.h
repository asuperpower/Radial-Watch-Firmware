...
**
**     Reference manual:    K63P144M120SF5RM, Rev.1, July 2013
**     Version:             rev. 1.3, 2013-12-09
**
**     Abstract:
**         This header file implements peripheral memory map for MK63F12WS
**         processor.
**
 ...
 * @version 1.3
 * @date 2013-12-09
 * @brief Peripheral memory map for MK63F12WS
 *
 * This header file implements peripheral memory map for MK63F12WS processor.
 */
...
#if !defined(MCU_MK63F12WS)  /* Check if memory map has not been already included */
#define MCU_MK63F12WS

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK63F12WS memory map: There is already included another memory map. Only one memory map can be included.
...
typedef enum {
  ...
  INT_Tamper                   = 71,               /**< Tamper detect interrupt */
...
typedef struct DRY_MemMap {
  ...
  uint32_t PGFR[6];                                /**< DryIce Pin Glitch Filter Register, array offset: 0x40, array step: 0x4 */
  uint8_t RESERVED_2[1960];
...
#define DRY_BASE_PTRS                            { DRY_BASE_PTR }
...
/* TTR Bit Fields */
#define RTC_TTR_VDTH_MASK                        0x7u
#define RTC_TTR_VDTH_SHIFT                       0
#define RTC_TTR_VDTH(x)                          (((uint32_t)(((uint32_t)(x))<<RTC_TTR_VDTH_SHIFT))&RTC_TTR_VDTH_MASK)
#define RTC_TTR_VDTL_MASK                        0x38u
#define RTC_TTR_VDTL_SHIFT                       3
...
#endif  /* #if !defined(MCU_MK63F12WS) */
