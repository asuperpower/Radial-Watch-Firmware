...
**
**     Abstract:
**         This header file implements peripheral memory map for MKE04Z4
**         processor.
**
 ...
 * @version 1.0
 * @date 2013-05-09
 * @brief Peripheral memory map for MKE04Z4
 *
 * This header file implements peripheral memory map for MKE04Z4 processor.
 */
...
#if !defined(MCU_MKE04Z4)  /* Check if memory map has not been already included */
#define MCU_MKE04Z4
...
typedef enum {
  ...
  INT_FTMRE                    = 21,               /**< FTMRE command complete/read collision interrupt */
  ...
  INT_Reserved34               = 34,               /**< Reserved interrupt 34 */
  ...
  INT_PWT                      = 45,               /**< Pulse Width Timer Interrupt */
...
#define FGPIO_BASE_PTRS                          { FGPIOA_BASE_PTR }
...
#define FTM_BASE_PTRS                            { FTM0_BASE_PTR, FTM2_BASE_PTR }
