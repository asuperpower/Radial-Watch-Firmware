...
**
**     Abstract:
**         This header file implements peripheral memory map for MKM33Z5
**         processor.
**
 ...
 * @version 1.0
 * @date 2012-10-18
 * @brief Peripheral memory map for MKM33Z5
 *
 * This header file implements peripheral memory map for MKM33Z5 processor.
 */
...
#if !defined(MCU_MKM33Z5)  /* Check if memory map has not been already included */
#define MCU_MKM33Z5

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MKM33Z5 memory map: There is already included another memory map. Only one memory map can be included.
