...
**     Version:             rev. 2.4, 2013-06-24
**
**     Abstract:
**         This header file implements peripheral memory map for MK51D7
**         processor.
**
 ...
 * @version 2.4
 * @date 2013-06-24
 * @brief Peripheral memory map for MK51D7
 *
 * This header file implements peripheral memory map for MK51D7 processor.
 */
...
#if !defined(MCU_MK51D7)  /* Check if memory map has not been already included */
#define MCU_MK51D7

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK51D7 memory map: There is already included another memory map. Only one memory map can be included.
...
#define OPAMP_BASE_PTRS                          { OPAMP0_BASE_PTR, OPAMP1_BASE_PTR }
...
#define TRIAMP_BASE_PTRS                         { TRIAMP0_BASE_PTR }
...
#define UART_BASE_PTRS                           { UART0_BASE_PTR, UART1_BASE_PTR, UART2_BASE_PTR, UART3_BASE_PTR, UART4_BASE_PTR }
