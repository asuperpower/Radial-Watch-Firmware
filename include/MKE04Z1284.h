...
**
**     Reference manual:    MKE04P80M48SF0RM, Rev. 1, Oct 2013
**     Version:             rev. 1.0, 2013-10-30
**
**     Abstract:
**         This header file implements peripheral memory map for MKE04Z1284
**         processor.
**
 ...
 * @version 1.0
 * @date 2013-10-30
 * @brief Peripheral memory map for MKE04Z1284
 *
 * This header file implements peripheral memory map for MKE04Z1284 processor.
 */
...
#if !defined(MCU_MKE04Z1284)  /* Check if memory map has not been already included */
...
#define I2C1_S1                                  I2C_S_REG(I2C1_BASE_PTR)
...
#else /* #if !defined(MCU_MKE04Z1284) */
...
#endif  /* #if !defined(MCU_MKE04Z1284) */
