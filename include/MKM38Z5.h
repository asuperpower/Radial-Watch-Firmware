...
**
**     Abstract:
**         This header file implements peripheral memory map for MKM38Z5
**         processor.
**
 ...
 * @version 1.0
 * @date 2012-10-18
 * @brief Peripheral memory map for MKM38Z5
 *
 * This header file implements peripheral memory map for MKM38Z5 processor.
 */
...
/* Check if another memory map has not been also included */
  ...
  #error MKM38Z5 memory map: There is already included another memory map. Only one memory map can be included.
