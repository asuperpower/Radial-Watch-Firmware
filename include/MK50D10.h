...
**
**     Abstract:
**         This header file implements peripheral memory map for MK50D10
**         processor.
**
 ...
 * @version 1.8
 * @date 2013-06-24
 * @brief Peripheral memory map for MK50D10
 *
 * This header file implements peripheral memory map for MK50D10 processor.
 */
...
#if !defined(MCU_MK50D10)  /* Check if memory map has not been already included */
#define MCU_MK50D10
