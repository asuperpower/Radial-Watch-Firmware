...
#if !defined(MCU_MKE06Z4) && !defined(MCU_SKEAZ1284)  /* Check if memory map has not been already included */
#define MCU_MKE06Z4
...
typedef struct MSCAN_MemMap {
  ...
  union {                                          /* offset: 0x21 */
    ...
    uint8_t TSIDR1;                                  /**< Transmit Standard Identifier Register 1, offset: 0x21 */
  };
...
#else /* #if !defined(MCU_MKE06Z4) && !defined(MCU_SKEAZ1284) */
...
#endif  /* #if !defined(MCU_MKE06Z4) && !defined(MCU_SKEAZ1284) */
