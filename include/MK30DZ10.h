...
**
**     Abstract:
**         This header file implements peripheral memory map for MK30DZ10
**         processor.
**
 ...
 * @version 1.5
 * @date 2013-04-05
 * @brief Peripheral memory map for MK30DZ10
 *
 * This header file implements peripheral memory map for MK30DZ10 processor.
 */
...
#if !defined(MCU_MK30DZ10)  /* Check if memory map has not been already included */
#define MCU_MK30DZ10

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK30DZ10 memory map: There is already included another memory map. Only one memory map can be included.
