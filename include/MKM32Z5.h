...
**
**     Abstract:
**         This header file implements peripheral memory map for MKM32Z5
**         processor.
**
 ...
 * @version 1.0
 * @date 2012-10-18
 * @brief Peripheral memory map for MKM32Z5
 *
 * This header file implements peripheral memory map for MKM32Z5 processor.
 */
...
#if !defined(MCU_MKM32Z5)  /* Check if memory map has not been already included */
#define MCU_MKM32Z5

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MKM32Z5 memory map: There is already included another memory map. Only one memory map can be included.
...
typedef struct AFE_MemMap {
  uint32_t CFR[2];                                 /**< Channel1 Configuration Register..Channel2 Configuration Register, array offset: 0x0, array step: 0x4 */
  ...
  uint32_t DR[2];                                  /**< Channel1 Delay Register..Channel2 Delay Register, array offset: 0x2C, array step: 0x4 */
  uint8_t RESERVED_2[16];
  uint32_t RR[2];                                  /**< Channel1 Result Register..Channel2 Result Register, array offset: 0x44, array step: 0x4 */
