...
**
**     Abstract:
**         This header file implements peripheral memory map for MK50D7
**         processor.
**
 ...
 * @version 1.4
 * @date 2013-06-24
 * @brief Peripheral memory map for MK50D7
 *
 * This header file implements peripheral memory map for MK50D7 processor.
 */
...
#if !defined(MCU_MK50D7)  /* Check if memory map has not been already included */
#define MCU_MK50D7

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK50D7 memory map: There is already included another memory map. Only one memory map can be included.
