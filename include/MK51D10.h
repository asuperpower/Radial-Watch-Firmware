...
**
**     Abstract:
**         This header file implements peripheral memory map for MK51D10
**         processor.
**
...
**     - rev. 1.2 (2012-03-26)
**         INT_RNG Interrupt Number Definitions removed.
 ...
 * @version 1.8
 * @date 2013-06-24
 * @brief Peripheral memory map for MK51D10
 *
 * This header file implements peripheral memory map for MK51D10 processor.
 */
...
#if !defined(MCU_MK51D10)  /* Check if memory map has not been already included */
#define MCU_MK51D10

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK51D10 memory map: There is already included another memory map. Only one memory map can be included.
...
#define TRIAMP_BASE_PTRS                         { TRIAMP0_BASE_PTR, TRIAMP1_BASE_PTR }
