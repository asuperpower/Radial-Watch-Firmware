...
**
**     Abstract:
**         This header file implements peripheral memory map for MK30D7
**         processor.
**
 ...
 * @version 1.4
 * @date 2013-06-24
 * @brief Peripheral memory map for MK30D7
 *
 * This header file implements peripheral memory map for MK30D7 processor.
 */
...
#if !defined(MCU_MK30D7)  /* Check if memory map has not been already included */
#define MCU_MK30D7

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK30D7 memory map: There is already included another memory map. Only one memory map can be included.
