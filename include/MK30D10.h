...
**
**     Abstract:
**         This header file implements peripheral memory map for MK30D10
**         processor.
**
 ...
 * @version 1.8
 * @date 2013-06-24
 * @brief Peripheral memory map for MK30D10
 *
 * This header file implements peripheral memory map for MK30D10 processor.
 */
...
#if !defined(MCU_MK30D10)  /* Check if memory map has not been already included */
#define MCU_MK30D10

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK30D10 memory map: There is already included another memory map. Only one memory map can be included.
