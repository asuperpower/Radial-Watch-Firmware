...
**
**     Abstract:
**         This header file implements peripheral memory map for MK20F12
**         processor.
**
 ...
 * @version 1.9
 * @date 2013-06-24
 * @brief Peripheral memory map for MK20F12
 *
 * This header file implements peripheral memory map for MK20F12 processor.
 */
...
#if !defined(MCU_MK20F12)  /* Check if memory map has not been already included */
#define MCU_MK20F12

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error MK20F12 memory map: There is already included another memory map. Only one memory map can be included.
